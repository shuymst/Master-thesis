...
TD afterstate学習は$s$からafterstate $s'$への遷移までをシミュレートする， いわば$0.5$手読みの探索を行っているため， $0$手読みのQ学習を上回ると考えられる．
...
Antonoglouらが提案したStochastic MuZero~\cite{StochasticMuZero}は， 2048において．
Stochastic MuZeroは~\ref{subsec: muzero}節で述べたMuZeroを， 確率的な環境にも対応できるように拡張した手法である．
